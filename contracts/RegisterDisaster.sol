...
require(index < people.length, "Index out of bounds"); 
    ...
    function getID(string memory _idCard) public view 
    returns (Person memory) 
    {
      require(idExists[_idCard], "Person not found"); 
